...
> Nguồn: Brief.pdf
> Chuyển đổi bằng MarkItDown, sau đó chuẩn hóa heading, list và code block để AI dễ đọc hơn.
> Lưu ý: phần data dictionary được trích từ bảng trong PDF nên căn cột vẫn có thể lệch; nếu cần độ chính xác tuyệt đối, nên đối chiếu thêm với database/source gốc.

## Link thiết kế
https://drive.google.com/drive/folders/1PHWNbxX_1CoeqtqYWuAs5QnqO12Rj7tA?usp=sharing

1. Thông tin chung: Web-App quản lý hợp đồng, tính công và tiền lương
2. Thời gian: Trước 10/4 cần hoàn chỉnh
3. Framework

- Database: SQL Server; bảng, views, function và stored procedures để hiện lên phần mềm (bên t lo phần này)
...
- Usecase: nội dung sơ đồ không trích xuất được từ PDF
- Class: nội dung sơ đồ không trích xuất được từ PDF
- Sequence: nội dung sơ đồ không trích xuất được từ PDF
...
3. Khi sửa hoặc tạo bản ghi mới thì sẽ hiển thị pop-up hoặc tab mới trên browser màn hình editor chứ không để trong cùng 1 tab với màn hình hiển thị danh sách được không?
...
Folder các file sửa: HRM_Fujimart
...
3. Sửa lại navigator và các chức năng hiển thị theo BFD này (bỏ chữ quản lý đi khi lên phần mềm với các danh mục, chứng từ)

- Bổ sung thêm bảng lương (hiển thị D30Payroll đầu phiếu và D30PayrollDetail chi tiết) cho phép sửa dữ liệu ở quản lý tiền lương trước gửi email phiếu lương cá nhân
...
> Các block bên dưới giữ nguyên tinh thần trích xuất từ PDF để tránh làm sai nghĩa của schema.
...
10. Nhân viên bổ sung thêm các trường như Gender (Giới tính), BirthDate (Ngày sinh), IdCardNo (Số CCCD), Email (Địa chỉ email), Mobile (Số điện thoại), ResignDate (Ngày nghỉ việc)
